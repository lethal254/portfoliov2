...
const ProjectCard = (props) => {
  ...
  return (
    <div className='flex items-center rounded-md hover:-translate-y-1 transition-all ease-linear duration-300'>
      <div
        className='w-[100%] min-h-[50vh] md:min-h-[40vh] h-fit relative overflow-hidden cursor-pointer rounded-md'
        style={{ backgroundImage: `url("${projectImage.asset.url}")` }}>
